...
def processRestaurantInfoIntent(req):
    ...
    if RestaurantName != "":
        ...
        infoCount, website, RestName, address, phone, category, price_range, officeHours, take_out, delivery, reservation = getRestaurantInfoIntentHandler(RestaurantName)
    else:
    ...
    defaultRichMessage = [
            {
                "card": {
                    "title": RestName, "subtitle": address,
                    "imageUri": "",
...
def getRestaurantInfoIntentHandler(RestaurantName):
    """
